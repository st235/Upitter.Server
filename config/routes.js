module.exports = {
	...
	post: {
		...
		obtainNewFavorites: '/post/favoritesNew',
		...
		obtainOldPostsBySubscriptions: '/post/obtainOldBySubscriptions',
		obtainNewPostsBySubscriptions: '/post/obtainNewBySubscriptions'
	},
	report: {
